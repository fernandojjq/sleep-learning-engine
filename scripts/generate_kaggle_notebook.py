...
cells = [
    ...
    code(
        ...
        "#",
        "# The package does NOT bundle any ambient music. You must bring",
        "# your own .mp3 files (Minimax Music 2.6, Udio, Suno, Stable",
        "# Audio, or any royalty-free source you have a license for) and",
        "# add them as a Kaggle dataset attached to this notebook.",
        ...
        "",
        "# Copy the user's ambient dataset (Kaggle input) into the work",
        "# dir. The user adds the dataset via the + Add data panel; it",
        "# shows up as /kaggle/input/<dataset-slug>/.",
        ...
        '    print("")',
        '    print("  1. Prepare a Kaggle dataset with 3+ ambient .mp3 files.")',
        '    print("     Recommended sources: Minimax Music 2.6, Udio, Suno, Stable Audio,")',
        '    print("     or any royalty-free loops you have a license for.")',
        '    print(f"  2. Add the dataset to this notebook (slugs to: {AMBIENT_SRC_SLUG}).")',
        '    print("  3. Re-run this cell. The render will pick them up automatically.")',
        '    print("=" * 60)',
        "    raise FileNotFoundError(",
        '        f"Missing ambient dataset at {AMBIENT_SRC}. See instructions above."',
        "    )",
        "",
        "copied = 0",
        ...
        '    print("Add at least 3-5 .mp3 files to your Kaggle dataset and re-run this cell.")',
        "    raise FileNotFoundError(",
