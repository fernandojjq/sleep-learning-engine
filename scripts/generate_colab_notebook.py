...
cells = [
    ...
    code(
        ...
        '    print("The encode will fall back to libx264 (CPU), which is 5-10x slower.")',
        '    print("")',
        '    print("Fix: Runtime -> Change runtime type -> T4 GPU -> Save.")',
        '    print("You will be prompted to reconnect. Then re-run this cell.")',
        '    print("=" * 60)',
        "",
        ...
        "else:",
        '    print("NVENC encoder: NOT in ffmpeg build (will use libx264 CPU fallback)")',
    ),
    code(
